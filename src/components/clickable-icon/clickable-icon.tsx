...
export const ClickableIcon = (props: ClickableIconProps) => {
  const classes = props.className ? `clickable-icon ${props.className}` : 'clickable-icon';

  switch (props.iconType) {
    case "activity" : return <Link className='clickable-icon-container' to={props.to}><Activity className={classes} /></Link>;
    case "airplay" : return <Link className='clickable-icon-container' to={props.to}><Airplay className={classes} /></Link>;
    case "alert-circle" : return <Link className='clickable-icon-container' to={props.to}><AlertCircle className={classes} /></Link>;
    case "alert-octagon" : return <Link className='clickable-icon-container' to={props.to}><AlertOctagon className={classes} /></Link>;
    case "alert-triangle" : return <Link className='clickable-icon-container' to={props.to}><AlertTriangle className={classes} /></Link>;
    case "align-center" : return <Link className='clickable-icon-container' to={props.to}><AlignCenter className={classes} /></Link>;
    case "align-justify" : return <Link className='clickable-icon-container' to={props.to}><AlignJustify className={classes} /></Link>;
    case "arrow-down-circle" : return <Link className='clickable-icon-container' to={props.to}><ArrowDownCircle className={classes} /></Link>;
    case "arrow-down-left" : return <Link className='clickable-icon-container' to={props.to}><ArrowDownLeft className={classes} /></Link>;
    case "arrow-down-right" : return <Link className='clickable-icon-container' to={props.to}><ArrowDownRight className={classes} /></Link>;
    case "arrow-down" : return <Link className='clickable-icon-container' to={props.to}><ArrowDown className={classes} /></Link>;
    case "arrow-left-circle" : return <Link className='clickable-icon-container' to={props.to}><ArrowLeftCircle className={classes} /></Link>;
    ...
    case "chevron-left" : return <Link className='clickable-icon-container' to={props.to}><ChevronLeft className={classes} /></Link>
    case "chevrons-left" : return <Link className='clickable-icon-container' to={props.to}><ChevronsLeft className={classes} /></Link>;
    case "chevron-right" : return <Link className='clickable-icon-container' to={props.to}><ChevronRight className={classes} /></Link>
    case "chevrons-right" : return <Link className='clickable-icon-container' to={props.to}><ChevronsRight className={classes} /></Link>;
    case "chevron-up" : return <Link className='clickable-icon-container' to={props.to}><ChevronUp className={classes} /></Link>;
    case "chevrons-up" : return <Link className='clickable-icon-container' to={props.to}><ChevronsUp className={classes} /></Link>;
    case "clock" : return <Link className='clickable-icon-container' to={props.to}><Clock className={classes} /></Link>;
    case "file" : return <Link className='clickable-icon-container' to={props.to}><File className={classes} /></Link>;
    case "logout" : return <Link className='clickable-icon-container' to={props.to}><Logout className={classes} /></Link>;
    case "trash" : return <Link className='clickable-icon-container' to={props.to}><Trash className={classes} /></Link>;
    case "search" : return <Link className='clickable-icon-container' to={props.to}><Search className={classes} /></Link>;
    case "settings" : return <Link className='clickable-icon-container' to={props.to}><Settings className={classes} /></Link>;
    case "trending-up" : return <Link className='clickable-icon-container' to={props.to}><TrendingUp className={classes} /></Link>;
    case "user" : return <Link className='clickable-icon-container' to={props.to}><User className={classes} /></Link>;
    case "users" : return <Link className='clickable-icon-container' to={props.to}><Users className={classes} /></Link>;
    case "x" : return <Link className='clickable-icon-container' to={props.to}><X className={classes} /></Link>;
    case "x-circle" : return <Link className='clickable-icon-container' to={props.to}><XCircle className={classes} /></Link>;
  }
}

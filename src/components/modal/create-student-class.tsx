...
const createStudentClassVariants = cva(
...
export function CreateStudentClass({ mode, variant, close, className }: createClassProps) {
  ...
  const handleClose = () => {
    close()
    setStudentClassData(
      { name: '', modality: '', course: '', classroom: '', startTime: '', endTime: '' }
    )
  }
          ...
          <div className='content-body'>
            <form id='class-form' onSubmit={handleSubmit}>
              <ModalRow labels={['Turma']} mode={mode} >
                <Input type='text' name='name' value={studentClassData.name} placeholder='Turma' mode={mode} onChange={handleChange} />
              </ModalRow>

              <ModalRow labels={['Modalidade', 'Curso']} mode={mode}>
                <Input type='select' name='modality' value={studentClassData.modality} placeholder='Selecione a modalidade' mode={mode} onChange={handleChange} />
                <Input type='select' name='course' value={studentClassData.course} placeholder='Selecione o curso' mode={mode} onChange={handleChange} />
              </ModalRow>

              <ModalRow labels={['Sala', 'Horário']} mode={mode}>
                <Input type='text' name='classroom' value={studentClassData.classroom} mode={mode} onChange={handleChange} />
                <Input type='time' names={['startTime', 'endTime']} value={[studentClassData.startTime, studentClassData.endTime]} mode={mode} onChange={handleChange} />
              </ModalRow>
            </form>
          </div>

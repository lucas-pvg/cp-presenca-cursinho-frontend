...
export function SelectList({ items, mode, variant, close, verifyIncluded, handleListChange, className, confirm }: ListProps) {
  const handleClose = () => {
    close()
  }
  ...
  return (
    ...
    <div className={selectListVariants({ mode })}>
      ...
      <div className='modal-content'>
        ...
        <ModalFooter form='class-form' mode={mode} close={() => handleClose()} confirm={confirm}/>
      </div>
    </div>
  </div>
  );

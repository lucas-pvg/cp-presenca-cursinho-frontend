...
export class LessonRecurrentDatetime
  implements LessonRecurrentDatetimeInterface
{
  id: number;
  lessonRecurrency: number;
  startDatetime: Date;
  ...
  startTimeFormat(): string {
    return this.startDatetime.toLocaleTimeString('pt-br', {
      timeStyle: 'short',
    });
  }
  ...
  dayOfWeekFormat(): string {
    switch (this.dayOfWeek) {
      ...
      case 6:
        return 'Domingo';
      default:
        return 'Dia da semana não especificado';
    }
  }
}

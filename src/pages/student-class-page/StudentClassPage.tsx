          ...
          <div className="column">
            ...
            <div className="cards">
              <TextCard iconType="book" label="Curso">
                {studentClasses?.[index].course ?? ''}
              </TextCard>
              <TextCard
                iconType="clock"
                label="Horário"
              >{`${formattedTime(studentClasses?.[index].startDateTime.getHours(), studentClasses?.[index].startDateTime.getMinutes())} - ${formattedTime(studentClasses?.[index].endDateTime.getHours(), studentClasses?.[index].endDateTime.getMinutes())}`}</TextCard>
              <TextCard iconType="clipboard" label="Sala">
                {studentClasses?.[index].classroom ?? ''}
              </TextCard>
              <TextCard iconType="users" label="Modalidade">
                {studentClasses?.[index].modality ?? ''}
              </TextCard>
            </div>
          </div>
        )}
